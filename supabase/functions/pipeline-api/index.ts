// pipeline-api — routed Edge Function.
...
const app = createRouter("pipeline-api");

// Health probe (always public)
app.get("/__health", (c) => jsonOk(c, { fn: "pipeline-api", ok: true }));
...
app.post("/move", async (c) => jsonErr(c, "not_migrated", "Route scaffolded; logic not yet migrated.", 501));
