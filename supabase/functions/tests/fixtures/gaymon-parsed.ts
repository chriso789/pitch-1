...
export const gaymonCarrierLineItems = [
  ...
  li({ raw_description: 'Roofing felt - 15 lb.', quantity: 30.77, unit: 'SQ', total_rcv: 450.00 }),
  li({ raw_description: 'Drip edge', quantity: 224, unit: 'LF', total_rcv: 380.00 }),
  li({ raw_description: 'Asphalt starter - universal starter course', quantity: 224, unit: 'LF', total_rcv: 360.00 }),
  ...
  li({ raw_description: 'R&R Soffit - metal', quantity: 12, unit: 'LF', total_rcv: 1000.00, section_name: 'FRONT ELEVATION', raw_category: 'FRONT ELEVATION' }),
  // exterior items
  ...
  // padding lines to hit ~21 carrier items + totals ~14,718
