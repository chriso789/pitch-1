...
const app = createRouter("job-api");

// Health probe (always public)
app.get("/__health", (c) => jsonOk(c, { fn: "job-api", ok: true }));
...
app.post("/approve-from-lead", async (c) => jsonErr(c, "not_migrated", "Route scaffolded; logic not yet migrated.", 501));
