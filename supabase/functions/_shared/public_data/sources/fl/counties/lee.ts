// supabase/functions/_shared/public_data/sources/fl/counties/lee.ts
...
const config: ArcGISCountyConfig = {
  id: "fl_lee_arcgis",
  serviceUrl:
    "https://gis.leepa.org/arcgis/rest/services/Parcels/MapServer/0",
...
export function lee(input: CountyLookupInput): Promise<CountyLookupResult> {
