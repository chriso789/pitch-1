...
export const PLAN_CATALOG: PlanSeed[] = [
  {
    ...
    name: "Basic",
    tier: "basic",
    description: "Core CRM for a single crew — contacts, pipeline, estimates.",
    price_monthly: 50,
    price_yearly: 500,
    trial_days: 14,
    sort_order: 1,
    features: ["CRM & pipeline", "Estimates & invoices", "250 SMS / mo", "5 GB storage"],
    limits: { sms_monthly: 250, ai_prompts_monthly: 100, storage_mb: 5120, roof_reports_monthly: 0 },
  },
  {
    slug: "starter",
    name: "Starter",
    tier: "starter",
    description: "Full CRM plus canvassing, photo reports, and AI measurements.",
    price_monthly: 399,
    price_yearly: 3990,
    trial_days: 14,
    sort_order: 2,
    features: ["Everything in Basic", "Live canvassing", "2,000 SMS / mo", "5 AI roof reports / mo"],
    limits: { sms_monthly: 2000, ai_prompts_monthly: 1500, storage_mb: 25000, roof_reports_monthly: 5 },
  },
  {
    slug: "growth",
    name: "Growth",
    tier: "growth",
    description: "Multi-crew operations with power dialer and supplier integrations.",
    price_monthly: 799,
    price_yearly: 7990,
    trial_days: 14,
    sort_order: 3,
    features: ["Everything in Starter", "Power dialer", "10,000 SMS / mo", "20 AI roof reports / mo"],
    limits: { sms_monthly: 10000, ai_prompts_monthly: 10000, storage_mb: 100000, roof_reports_monthly: 20 },
  },
];
