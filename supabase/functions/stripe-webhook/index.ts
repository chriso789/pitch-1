// stripe-webhook — routed Edge Function.
...
const app = createRouter("stripe-webhook");

// Health probe (always public)
app.get("/__health", (c) => jsonOk(c, { fn: "stripe-webhook", ok: true }));
...
app.post("/events", async (c) => jsonErr(c, "not_migrated", "Route scaffolded; logic not yet migrated.", 501));
