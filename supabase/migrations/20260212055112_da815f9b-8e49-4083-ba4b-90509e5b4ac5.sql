-- Deduplicate search: exclude leads that have been converted to projects, and return pipeline_entry_id for jobs
...
BEGIN
  ...
  -- PROJECTS: return pipeline_entry_id as entity_id for direct /lead/ navigation
  SELECT 
