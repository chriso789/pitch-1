ALTER TABLE public.roof_measurements
  DROP CONSTRAINT IF EXISTS roof_measurements_footprint_source_check;
...
ALTER TABLE public.roof_measurements
  ...
  CHECK (
    ...
    OR footprint_source = ANY (ARRAY[
      ...
      -- New sources from footprint candidate selector
      'google_solar_bbox','google_solar_segments','unet_mask','alpha_hull','convex_hull'
    ])
  );