-- Step 1: Add tenant_id column (nullable for existing global materials)
...
-- Step 3: Update unique constraint to be tenant-scoped
-- Drop old constraint if exists
ALTER TABLE public.materials DROP CONSTRAINT IF EXISTS materials_code_key;

-- Create new tenant-scoped unique constraint (allows same code for different tenants)
DROP INDEX IF EXISTS materials_code_tenant_unique;
...
-- Step 4: Update the upsert function to handle tenant_id
