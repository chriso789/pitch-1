...
export const MultiTemplateSelector: React.FC<MultiTemplateSelectorProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Measurement Summary with Inline Import */}
      <Card>
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base flex items-center gap-2">
              <Ruler className="h-4 w-4" />
              {isImporting ? 'Import Measurement Report' : (measurementSummary && measurementSummary.totalSquares > 0 ? 'Applied Measurements' : 'Measurements')}
            </CardTitle>
            {!isImporting ? (
              <Button 
                variant="outline" 
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>{formatNumber(importParsedData.rakes_ft)} ft</span>
                        </div>
                      </div>
                    </div>
                  </div>
