...
const Sidebar = ({ activeSection, onSectionChange }: SidebarProps) => {
  ...
  return (
    <div className="w-64 bg-card border-r border-border shadow-soft h-screen flex flex-col">
      {/* Logo & Header */}
        ...
        <nav className="space-y-2">
          {navigation.map((item) => (
            <button
              ...
              className={cn(
                "w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-smooth group",
