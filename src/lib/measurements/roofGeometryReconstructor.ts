...
/**
 * Reconstruct a standard hip roof - ALWAYS uses single ridge with hips to corners
 * 
 * Proper hip roof geometry:
 * 1. Single ridge along the LONGEST axis
 * 2. 4 hips connecting each corner to the NEAREST ridge endpoint
 * 3. 4 facets: 2 trapezoids (long sides) + 2 triangles (short sides)
 * 
 * This replaces the cross-hip logic which incorrectly created a starburst pattern.
 */
 ...
 * 
 * Proper hip roof geometry:
 * 1. Single ridge along the LONGEST axis of the building
 * 2. 4 hips connecting each corner to the NEAREST ridge endpoint
 * 3. 4 facets: 2 trapezoids (along ridge) + 2 triangles (at ends)
 * 
