              ...
              {isCollapsed ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      className={cn(
                        "w-full flex items-center rounded-md text-left transition-colors group px-2 py-2 justify-center",
                  ...
                  <DropdownMenuContent side="right" align="start" className="w-56">
                    <DropdownMenuLabel>Follow Up Hub</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem onClick={() => { navigate('/communications'); onNavigate?.(); }}>
                      <Inbox className="h-3.5 w-3.5 mr-2" /> Inbox
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => { navigate('/communications/unmatched'); onNavigate?.(); }}>
                      <MessageSquare className="h-3.5 w-3.5 mr-2" /> Unmatched
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => { navigate('/communications/ai-queue'); onNavigate?.(); }}>
                      <Bot className="h-3.5 w-3.5 mr-2" /> AI Queue
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => { navigate('/communications/calls'); onNavigate?.(); }}>
                      <PhoneCall className="h-3.5 w-3.5 mr-2" /> Call Center
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => { navigate('/ai-agent-dashboard'); onNavigate?.(); }}>
                      <Bot className="h-3.5 w-3.5 mr-2" /> AI Agent
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              ) : (
                <>
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center rounded-md text-left transition-colors group gap-3 px-3 py-2",
                      activeSection === 'communications'
                        ? "bg-primary/10 text-primary border-l-2 border-primary"
                        : "text-muted-foreground hover:bg-accent hover:text-accent-foreground border-l-2 border-transparent"
                    )}
                  ...
                  {(followUpExpanded || activeSection === 'communications') && (
              ...
              {(insuranceExpanded || activeSection === 'insurance') && !isCollapsed && (
                <div className="ml-4 pl-3 border-l border-border space-y-0.5">
                  ...
                  <Link
                    ...
                    className={cn(
                      "w-full flex items-center gap-3 px-3 py-1.5 rounded-md text-left transition-colors group",
                      location.pathname === '/supplements'
                        ? "bg-primary/10 text-primary"
                        : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                    )}
                  >
                    <ClipboardCheck className="h-3.5 w-3.5" />
                    <span className="text-sm">Supplement Engine</span>
                  </Link>
                  <Link
                    to="/supplement-workflow"
                    onClick={onNavigate}
                    className={cn(
                      "w-full flex items-center gap-3 px-3 py-1.5 rounded-md text-left transition-colors group",
                      location.pathname === '/supplement-workflow'
                        ? "bg-primary/10 text-primary"
                        : "text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                    )}
                  >
